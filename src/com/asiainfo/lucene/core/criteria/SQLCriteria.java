...
public class SQLCriteria extends HashMap {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6890885721156601358L;

	private static transient Log log = LogFactory.getLog(SQLCriteria.class);
	...
	private SQLCriteria add(String column, Object value, SqlEnum comparison) {
	...
	public SQLCriteria addEqual(String column, double value) {
		add(column, new Double(value), EQUAL);
		return this;
	}

	public SQLCriteria addEqual(String column, float value) {
		add(column, new Float(value), EQUAL);
		return this;
	}

	public SQLCriteria addEqual(String column, int value) {
		add(column, new Integer(value), EQUAL);
		return this;
	}

	public SQLCriteria addEqual(String column, String value) {
		add(column, value, EQUAL);
		return this;
	}

	public SQLCriteria addEqual(String column, String value, boolean isWrapperComma) {
		if (isWrapperComma) {
			value = "'" + value + "'";
		}
		add(column, value, EQUAL);
	...
	public SQLCriteria addEqual(String column, long value) {
		add(column, new Long(value), EQUAL);
		return this;
	}

	public SQLCriteria addNotEqual(String column, double value) {
		add(column, new Double(value), NOT_EQUAL);
		return this;
	}

	public SQLCriteria addNotEqual(String column, float value) {
		add(column, new Float(value), NOT_EQUAL);
		return this;
	}

	public SQLCriteria addNotEqual(String column, int value) {
		add(column, new Integer(value), NOT_EQUAL);
		return this;
	}

	public SQLCriteria addNotEqual(String column, String value) {
		add(column, value, NOT_EQUAL);
		return this;
	}

	public SQLCriteria addNotEqual(String column, String value, boolean isWrapperComma) {
		if (isWrapperComma) {
			value = "'" + value + "'";
		}
		add(column, value, NOT_EQUAL);
	...
	public SQLCriteria addNotEqual(String column, long value) {
		add(column, new Long(value), NOT_EQUAL);
		return this;
	}

	public SQLCriteria addGREATERThan(String column, double value) {
		add(column, new Double(value), GREATER_THAN);
		return this;
	}

	public SQLCriteria addGREATERThan(String column, float value) {
		add(column, new Float(value), GREATER_THAN);
		return this;
	}

	public SQLCriteria addGREATERThan(String column, int value) {
		add(column, new Integer(value), GREATER_THAN);
		return this;
	}

	public SQLCriteria addGREATERThan(String column, long value) {
		add(column, new Long(value), GREATER_THAN);
		return this;
	}

	public SQLCriteria addGREATERThan(String column, Timestamp value) {
		add(column, value, GREATER_THAN);
		return this;
	}

	public SQLCriteria addLESSThan(String column, double value) {
		add(column, new Double(value), LESS_THAN);
		return this;
	}

	public SQLCriteria addLESSThan(String column, float value) {
		add(column, new Float(value), LESS_THAN);
		return this;
	}

	public SQLCriteria addLESSThan(String column, int value) {
		add(column, new Integer(value), LESS_THAN);
		return this;
	}

	public SQLCriteria addLESSThan(String column, long value) {
		add(column, new Long(value), LESS_THAN);
		return this;
	}

	public SQLCriteria addLESSThan(String column, Timestamp value) {
		add(column, value, LESS_THAN);
		return this;
	}

	public SQLCriteria addGREATEREqual(String column, double value) {
		add(column, new Double(value), GREATER_EQUAL);
		return this;
	}

	public SQLCriteria addGREATEREqual(String column, float value) {
		add(column, new Float(value), GREATER_EQUAL);
		return this;
	}

	public SQLCriteria addGREATEREqual(String column, int value) {
		add(column, new Integer(value), GREATER_EQUAL);
		return this;
	}

	public SQLCriteria addGREATEREqual(String column, long value) {
		add(column, new Long(value), GREATER_EQUAL);
		return this;
	}

	public SQLCriteria addGREATEREqual(String column, Timestamp value) {
		add(column, value, GREATER_EQUAL);
		return this;
	}

	public SQLCriteria addLESSEqual(String column, double value) {
		add(column, new Double(value), LESS_EQUAL);
		return this;
	}

	public SQLCriteria addLESSEqual(String column, float value) {
		add(column, new Float(value), LESS_EQUAL);
		return this;
	}

	public SQLCriteria addLESSEqual(String column, int value) {
		add(column, new Integer(value), LESS_EQUAL);
		return this;
	}

	public SQLCriteria addLESSEqual(String column, long value) {
		add(column, new Long(value), LESS_EQUAL);
		return this;
	}

	public SQLCriteria addLESSEqual(String column, Timestamp value) {
		add(column, value, LESS_EQUAL);
		return this;
	}

	public SQLCriteria addLIKE(String column, String value) {
		add(column, value, LIKE);
		return this;
	}

	public SQLCriteria addNotLIKE(String column, String value) {
		add(column, value, NOT_LIKE);
		return this;
	}

	public SQLCriteria addIn(String column, int[] values) {
		add(column, values, IN);
		return this;
	}

	public SQLCriteria addIn(String column, long[] values) {
		add(column, values, IN);
		return this;
	}

	public SQLCriteria addIn(String column, List values) {
		add(column, values, IN);
		return this;
	}

	public SQLCriteria addNotIn(String column, int[] values) {
		add(column, values, NOT_IN);
		return this;
	}

	public SQLCriteria addNotIn(String column, long[] values) {
		add(column, values, NOT_IN);
		return this;
	}

	public SQLCriteria addNotIn(String column, List values) {
		add(column, values, NOT_IN);
		return this;
	}

	public SQLCriteria addIsNull(String column) {
		add(column, null, ISNULL);
		return this;
	}

	public SQLCriteria addIsNotNull(String column) {
		add(column, null, ISNotNULL);
		return this;
	}

	public SQLCriteria addSelectColumn(String name) {
	...
	public SQLCriteria addAscendingOrderByColumn(String name) {
		this.orderByColumns.add(name + ' ' + ASC);
		return this;
	}

	public SQLCriteria addDescendingOrderByColumn(String name) {
	...
	public SQLCriteria add(Criterion c) {
	...
	public SQLCriteria and(Criterion c) {
	...
	private SQLCriteria or(Criterion c) {
		Criterion oc = getCriterion(c.getTable() + '.' + c.getColumn());
	...
	public final class Criterion implements Serializable {
		...
		Criterion(String tableColumn, Object val) {
			this(tableColumn, val, SQLCriteria.EQUAL);
		}
		...
		public Criterion and(Criterion criterion) {
			Criterion c = new Criterion(criterion.getTable(), criterion.getColumn(), criterion.getValue(), criterion.getComparison());
			this.clauses.add(c);
		...
		public void appendTo(StringBuilder sb) {
			...
			if (SQLCriteria.CUSTOM == this.comparison) {
